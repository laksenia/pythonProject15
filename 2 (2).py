...
class Player(arcade.Sprite):
    def __init__(self):
        super().__init__(':resources:images/animated_characters/robot/robot_climb1.png', SPRITE_SCALING_PLAYER)
...
class Laser(arcade.Sprite):
    def __init__(self):
        super().__init__(':resources:images/cards/cardClubsJ.png', SPRITE_SCALING_LASER, angle=180)
        self.change_y = 2
...
class Enemy(arcade.Sprite):
    def __init__(self):
        super().__init__(':resources:images/alien/alienBlue_jump.png', SPRITE_SCALING_ENEMY, angle=180)
        self.change_y = 1
...
class Game(arcade.Window):
    def __init__(self):
        ...
        self.background_texture = arcade.load_texture(':resources:images/backgrounds/abstract_1.jpg')
